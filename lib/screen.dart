...
//   Path path;
//   bool isSand;
//   HomeScreen({super.key, required this.path, required this.isSand});
...
//         (screenWidth - widget.path.getBounds().width) / 2;
//     double verticalPadding =
//         (screenHeight - widget.path.getBounds().height) / 2;
...
//                           },
//                           child: Container(
//                             decoration: color == colorList[index]
//                                 ? BoxDecoration(
...
//                   Offset offset =
//                       renderBox.globalToLocal(position.localPosition);
//                   //List<CoordinateModel> newList = pointList;
//                   setState(() {
//                     pointList.add(CoordinateModel(
//                         offset: offset, color: color, width: width));
//                   });

//                   // controller.updateList(newList);
//                 } else {
//                   // audioPlayer.stop();
...
//                     CustomPathPainter(path: widget.path, isSand: widget.isSand),
//                 foregroundPainter: DrawingPainter(
//                   pointsMap: pointList,
//                   path: widget.path,
//                   isSand: widget.isSand,
//                 ),
//                 child: Container(),
//               )),
//         ),
...
//   List<CoordinateModel> pointsMap;
//   Path path;
//   bool isSand;
//   DrawingPainter({
...
//       paint.strokeWidth = pointsMap[i].width;
//       canvas.drawPoints(PointMode.points, [pointsMap[i].offset], paint);
//     }
//   }
